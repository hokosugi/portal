...
*WebAssembly 実行は サンドボックス・プロセスの中で行われます。これは、悪意のある によって悪用される可能性のある ランタイムのバグから、システムや他の を保護するためです。canister canister WebAssembly canisters *
...
**このような詳細な要約をありがとうございます。ランタイム環境が解決するWebAssembly に関する問題のいくつかが含まれていることに本当に感謝しています。このような具体的な問題についての洞察はとても勉強になりますし、認識しておくと有益だと思います！**
...
*- Wasm コンパイルキャッシュは、Open Chat や Hot-or-Not のような何千ものcanisters を持つdapps のcanister アップグレードを高速化します。*
